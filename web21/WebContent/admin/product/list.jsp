...
<script type="text/javascript">
	function addProduct() {
		window.location.href = "${pageContext.request.contextPath}/admainAddProductUIServlet";
	}
	...
	function delProduct(pid) {
		...
		if (isDel) {
			//要删除
			window.location.href = "${pageContext.request.contextPath}/admainDelProductServlet?pid="
					+ pid;
		}
	}
...
<body>
	...
	<form id="Form1" name="Form1"
		action="${pageContext.request.contextPath}/admainSearchProductListServlet"
		method="post">
							...
							<c:forEach items="${productList }" var="product" varStatus="vs">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/admainUpdateProductServlet?pid=${product.pid}">
											<img
